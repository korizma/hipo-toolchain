...
bool execute_machine_instr(s_emu_state* state, s_machine_instruction instr)
{
    ...
    {
        case 0x0:
            return handle_oc_0000(state, instr);
            
        case 0x1:
            return handle_oc_0001(state, instr);
            
        case 0x2:
            return handle_oc_0010(state, instr);
        case 0x3:
            return handle_oc_0011(state, instr);   

        case 0x4:
            return handle_oc_0100(state, instr);

        case 0x5:
            return handle_oc_0101(state, instr);
            
        case 0x6:
            return handle_oc_0110(state, instr);
            
        case 0x7:
            return handle_oc_0111(state, instr);
            
        case 0x8:
            return handle_oc_1000(state, instr);
            
        case 0x9:
            return handle_oc_1001(state, instr);
